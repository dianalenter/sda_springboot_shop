...
import com.sda.dianalenter.webshop.model.*;
import com.sda.dianalenter.webshop.repository.BillRepository;
import com.sda.dianalenter.webshop.repository.CustomerRepository;
import com.sda.dianalenter.webshop.repository.OrderRepository;
        ...
        if (customer.isPresent()) {
            ...
            for (Long productId : orderDTO.getProductIds()) {
                ...
                if (product.isPresent()) {
                    ...
                    throw new IllegalArgumentException("No product was found in DB for given Id:" + productId);
                }
            }
